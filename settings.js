...
global.owner = process.env.OWNER_NUMBER || '2349152597171'
const _0x327eef = {}
_0x327eef.SESSION_ID = process.env.SESSION_ID || 'VAJIRA-MD=TUlXWLLC#1JM7GOBNtM9dynci5YsEDmVB32qtYAofWiGx52oQ86o'
_0x327eef.travaSend = process.env.TRAVA_SEND || '25'
_0x327eef.MAX_SIZE =
  process.env.MAX_SIZE === undefined ? '1536' : process.env.MAX_SIZE
_0x327eef.OWNER_NAME = process.env.OWNER_NAME || '𝕃𝕚𝕝𝕡𝕣𝕖𝕤𝕙'
...
_0x327eef.DEVNUMBER = '2349152597171'
_0x327eef.DEVBOT = '2349152597171'
_0x327eef.CHANNEL = ''
